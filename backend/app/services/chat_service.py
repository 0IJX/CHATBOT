...
NO_LIVE_FACT_GUIDANCE = (
    "I can help with AURAK topics, your uploaded files, and general academic guidance, "
...
class ChatService:
    ...
    def _prepare_turn(
        ...
        if plan.greeting:
            reply_override = (
                "Hello. I can help with AURAK catalog questions, your uploaded syllabus or schedule, "
                "and general academic guidance."
            )
        elif plan.capability:
            reply_override = (
                "I can explain AURAK programs, compare majors, answer questions from your uploaded files, "
    ...
    def _plan_turn(
        ...
        mixed = (
            ("catalog" in text_lc or "aurak" in text_lc or "official" in text_lc)
            and ("my " in text_lc or "uploaded" in text_lc or "this file" in text_lc)
        ) or ("based on my" in text_lc and ("catalog" in text_lc or "aurak" in text_lc))
    ...
    def _build_model_messages(
        ...
        system_prompt = (
            "You are the AURAK AI assistant. Treat the AURAK catalog as institutional knowledge, "
    ...
    def _build_no_evidence_reply(self, plan: TurnPlan) -> str:
        if plan.answer_mode == "study_guidance":
            return (
                ...
                "If you want, I can still suggest a general study approach based on a typical AURAK course load."
            )
