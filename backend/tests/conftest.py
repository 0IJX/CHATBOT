...
def catalog_source(storage):
    ...
    source_id = 'catalog'
    storage.upsert_source(source_id, 'AURAK Catalog (All Catalog PDFs)', 'catalog', None)
    retrieval_service.index_source_text(
        source_id,
        'AURAK undergraduate offerings include Artificial Intelligence, Computer Science, '
